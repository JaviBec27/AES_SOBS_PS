...
{
    public partial class AES_SOBS_PSContext : DbContext
    {
        public AES_SOBS_PSContext()
        {
        }

        public AES_SOBS_PSContext(DbContextOptions<AES_SOBS_PSContext> options)
            : base(options)
        {
        }
        ...
        {
            optionsBuilder.UseSqlServer("Data Source=CTSCO5CG9263GHD;Initial Catalog=AES_SOBS_PS;Integrated Security=True;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False");
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<TokenUser>(entity =>
            {
                ...
                entity.HasIndex(e => e.Email)
                    .HasName("UQ__TokenUse__A9D10534F5C2672A")
                    .IsUnique();
